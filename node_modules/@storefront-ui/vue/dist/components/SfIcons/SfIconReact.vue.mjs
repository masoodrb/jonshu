import { defineComponent as a, openBlock as t, createBlock as s, unref as o, withCtx as n, createElementVNode as c } from "vue";
import m from "../SfIconBase/SfIconBase.vue.mjs";
import { SfIconSize as i } from "@storefront-ui/shared";
const r = /* @__PURE__ */ c("path", { d: "M13.96 11.952c0 1.099-.877 1.99-1.96 1.99s-1.96-.891-1.96-1.99.877-1.989 1.96-1.989 1.96.89 1.96 1.99" }, null, -1), q = /* @__PURE__ */ c("path", {
  "fill-rule": "evenodd",
